...
public class Day16_Annotations {
    ...
    @Test (enable=false) : Disable test case. By default, enable=true
    @Test (priority = number) : prioritize/order test case execution
    Note: Tests that are no priority parameter has a priority of 0, meaning @Test(priority=0) by default
